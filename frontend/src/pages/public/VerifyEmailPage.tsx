        ...
        <div className="w-full max-w-md card text-center py-12">
          {status === 'idle' && (
            <div className="flex flex-col items-center">
              ...
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4">{t('auth.verify_account')}</h2>
              ...
              >
                ...
                <span className="relative font-bold">{t('auth.activate_now')}</span>
              </button>
            </div>
          )}
          ...
          {status === 'loading' && (
            <div className="flex flex-col items-center py-8">
              ...
              <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-2">{t('auth.verifying')}</h2>
              <p className="text-gray-400">{t('auth.please_wait')}</p>
            </div>
          )}
          ...
          {status === 'success' && (
            <div className="flex flex-col items-center animate-in fade-in zoom-in duration-300">
              ...
              <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-2">{t('auth.verify_success')}</h2>
              <p className="text-gray-400 mb-8">{t('auth.verify_success_msg')}</p>
          ...
          {status === 'error' && (
            <div className="flex flex-col items-center animate-in fade-in zoom-in duration-300">
              ...
              <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-2">{t('auth.verify_failed')}</h2>
